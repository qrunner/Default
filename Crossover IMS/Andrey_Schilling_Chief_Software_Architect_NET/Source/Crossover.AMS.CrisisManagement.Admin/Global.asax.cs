...
namespace Crossover.AMS.CrisisManagement.Admin
{
    public class Global : System.Web.HttpApplication
    {
        ...
        public static void RegisterRoutes(RouteCollection routes)
        {
           ...
           // new CmsServiceContext().Database.Delete();
            DefaultModel.RegisterContext(() => ((IObjectContextAdapter)new CmsServiceContext()).ObjectContext, new ContextConfiguration {ScaffoldAllTables = true});
